...
func TestMii_Raw(t *testing.T) {
	...
	want := []byte{
		...
		0x8d, 0x00, 0x34, 0x29, 0x02, 0x52, 0x48, 0x50, 0x20, 0x00, 0x41, 0x00, 0x6c, 0x00, 0x6d, 0x00,
		0x69, 0x00, 0x67, 0x00, 0x68, 0x00, 0x74, 0x00, 0x79, 0x00, 0x20, 0x00, 0x00, 0x00, 0x10, 0xdc,
	}
